...
ALTER TABLE `commercial_movements` ADD CONSTRAINT `commercial_movements_classificationRuleId_classification_rules_id_fk` FOREIGN KEY (`classificationRuleId`) REFERENCES `classification_rules`(`id`) ON DELETE no action ON UPDATE no action;--> statement-breakpoint
